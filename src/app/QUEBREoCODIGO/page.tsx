...
export default function Index() {
  ...
  return (
    <>
      <div onClick={goBack} className="absolute tablet:p-24 p-12 font-mono hover:underline cursor-pointer">VOLTAR</div>
      <div className="flex flex-col items-center justify-center h-[100dvh] bg-black text-white font-mono p-4">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="flex gap-4">
            ...
            >
              {showNumbers ? "esconder resposta" : "mostrar resposta"}
            </button>
          </div>
          <button
